...
public class CompleteCameraController : MonoBehaviour {
    ...
    //private to set the value in the script here only and not need to change it too much like speed
    ...
    // LateUpdate is called after Update each frame to run all items per frame
	void LateUpdate () 
	{
